...
//         let current = arr[i];
//         let j;
//         console.log(`${i} iteration. Current valuse is ${current}`)
//         for (j = i - 1; j >= 0 && arr[j] > current; j--) {
//             console.log(`j: ${j}, arr[j]: ${arr[j]} is larger than current: ${current}. inner loop is fired`)
//             console.log(arr)
//             arr[j + 1] = arr[j];
//             console.log(arr)
//         }
...
console.log(selectionSort([0, 5, 2, -1, -10, 4, 7, 1]))